...
public class LogFormatter extends Formatter {
  ...
  static {
	  Logger tempLogger = LogFormatter.getLogger("");
  ...
  public static Logger getLogger(Class clss) {
	    // just referencing this class installs it
	    return Logger.getLogger(clss.getCanonicalName());
	  }
...
// formatter.format(date, buffer, new FieldPosition(0));
  ...
  public static void main(String args[]){
	  Logger log = LogFormatter.getLogger("test");
	  log.info(log.getParent().getName());
	  log.info("print info");
	  log.config("config");
	  log.setLevel(Level.FINEST);
	  log.fine("print finest");
	  log.severe("print severe");
  }
