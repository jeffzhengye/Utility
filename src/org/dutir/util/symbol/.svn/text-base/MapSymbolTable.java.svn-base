...
public class MapSymbolTable implements Compilable, Serializable, SymbolTable {
    ...
    public MapSymbolTable clone()
    {
    	try {
			return (MapSymbolTable) AbstractExternalizable.serializeDeserialize(this);
		} catch (IOException e) {
			e.printStackTrace();
		}
		return null;
    ...
    private static class UnmodifiableViewTable implements SymbolTable {
