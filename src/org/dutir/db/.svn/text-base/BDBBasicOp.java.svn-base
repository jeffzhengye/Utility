...
//		try {
//			BDBBasicOp bdb = new BDBBasicOp("testbdb1", DBConstant.READ_WRITE,
//					10);
//			////test iterator/////
//			bdb.putObject("12", "1234");
//			Object obj = bdb.getObject("12");
//			if(obj !=null){
...
//						this.fileName + "cnStringBytes.dbx",
//						this.databaseConfig);
//
...
//						this.fileName + "enStringBytes.dbx", 
//						this.databaseConfig);
//				if (this.mode == DBConstant.WRITE_ONLY) {
////					System.err
////							.println("Clearing out an existing database, removed "
...
//						+ "IntBytes.dbx",  this.databaseConfig);
//				if (this.mode == DBConstant.WRITE_ONLY) {
////					System.err
////							.println("Clearing out an existing database, removed "
...
//	 */
//	// ================================================|Constructor |====
//	public BDBBasicOp(String pFileName, int pMode, int pMaxCacheSize)
//			throws Exception {
//		this.mode = pMode;
//
//		// -------------------------------------------------------
...
//				dir.mkdirs();
//				System.out.println("making dir:" + dir.getAbsolutePath());
//			} else {
//
//			}
//
...
//					+ "IntInt.dbx", this.databaseConfig);
//
//			// --------------------------------
...
//		long returnValue = 0;
//		try {
//			BtreeStats someStats = (BtreeStats) database.getStats(null);
//			returnValue = someStats.getDupCountLeafNodeCount();
//		} catch (Exception e) {
//			returnValue = 0;
//		}
//		return (returnValue);
...
//						+ "enStringBytes.dbx",  this.databaseConfig);
//			}catch (DatabaseException e) {
//				e.printStackTrace();
//			}
//		}
...
//						+ "cnStringBytes.dbx", this.databaseConfig);
//			} catch (Exception e) {
//				e.printStackTrace();
//			}
//		}
