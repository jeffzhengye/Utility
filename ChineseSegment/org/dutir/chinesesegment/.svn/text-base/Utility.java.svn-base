...
public class Utility {
  ...
  public static final char[] STRING_CHAR_ARRAY = new String(" ")
      .toCharArray();

  public static final char[] NUMBER_CHAR_ARRAY = new String(" ")
      .toCharArray();

  public static final char[] START_CHAR_ARRAY = new String("@")
      .toCharArray();

  public static final char[] END_CHAR_ARRAY = new String("@").toCharArray();
  
  public static final String START_ARRAY = new String("@");

public static final String END_ARRAY = new String("@");
